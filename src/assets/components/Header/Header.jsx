...
import resume from '../../images/finalresume_Vishranth M S K.pdf'
const Header = () => { 
  ...
  return (
    ...
    <header /*ref={headerRef}* this is for sticky navbar*/ className="w-full h-[80px] bg-[#5C8374] leading-[80px] flex items-center">
      <div className='container'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex itmes-center gap-[10px]'>
            ...
            rounded-full flex items-center justify-center'><b>V</b></span>
